...
xsmm_gemm_dispatch(const libxsmm_datatype, int64_t, int64_t, int64_t, int64_t,
                   int64_t, int64_t, const libxsmm_gemm_flags, const libxsmm_datatype);
...
extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_unary_dispatch(
    ...
    int64_t, int64_t, const libxsmm_meltw_unary_flags, const libxsmm_datatype);
...
extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_binary_dispatch(
    ...
    int64_t, int64_t, int64_t, const libxsmm_meltw_binary_flags, const libxsmm_datatype);
...
extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_brgemm_dispatch(
    ...
    int64_t, int64_t, int64_t, const libxsmm_gemm_flags, const libxsmm_datatype);
...
extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_fused_brgemm_dispatch(
    ...
    const libxsmm_meltw_binary_type binary_op_type, const libxsmm_datatype c_type);
...
xsmm_brgemm_invoke(const libxsmm_datatype dType, int64_t addr,
                   ...
                   int64_t numBatches, const libxsmm_datatype cType);
...
extern "C" MLIR_RUNNERUTILS_EXPORT void xsmm_fused_brgemm_invoke(
    ...
    int64_t offsetC, void *alignedPtrD, int64_t offsetD, int64_t numBatches, const libxsmm_datatype cType);

extern "C" MLIR_RUNNERUTILS_EXPORT void
xsmm_intel_amx_tile_config_invoke(const libxsmm_datatype dType, int64_t addr,
                                  void *alignedPtrA, int64_t offset, const libxsmm_datatype cType);
