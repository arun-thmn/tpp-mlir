...
xsmm_gemm_dispatch(const libxsmm_datatype, const libxsmm_datatype, int64_t, int64_t, int64_t, int64_t,
                   int64_t, int64_t, const libxsmm_gemm_flags);

extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_unary_dispatch(
    const libxsmm_meltw_unary_type, const libxsmm_datatype, const libxsmm_datatype, int64_t, int64_t,
    int64_t, int64_t, const libxsmm_meltw_unary_flags);

extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_binary_dispatch(
    const libxsmm_meltw_binary_type, const libxsmm_datatype, const libxsmm_datatype, int64_t, int64_t,
    int64_t, int64_t, int64_t, const libxsmm_meltw_binary_flags);

extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_brgemm_dispatch(
    const libxsmm_datatype, const libxsmm_datatype, int64_t, int64_t, int64_t, int64_t, int64_t,
    int64_t, int64_t, int64_t, const libxsmm_gemm_flags);

extern "C" MLIR_RUNNERUTILS_EXPORT int64_t xsmm_fused_brgemm_dispatch(
    const libxsmm_datatype data_type,  const libxsmm_datatype c_type, int64_t m, int64_t n, int64_t k,
...
xsmm_gemm_invoke(const libxsmm_datatype dType,  const libxsmm_datatype cType, int64_t addr, void *alignedPtrA,
                 int64_t offsetA, void *alignedPtrB, int64_t offsetB,
                 void *alignedPtrC, int64_t offsetC);

extern "C" MLIR_RUNNERUTILS_EXPORT void
xsmm_unary_invoke(const libxsmm_datatype dType,  const libxsmm_datatype cType, int64_t addr,
                  void *alignedPtrIn, int64_t offsetIn, void *alignedPtrOut,
                  int64_t offsetOut);

extern "C" MLIR_RUNNERUTILS_EXPORT void
xsmm_unary_scalar_invoke(const libxsmm_datatype, const libxsmm_datatype,  int64_t addr, float scalar,
                         void *alignedPtrOut, int64_t offsetOut);

extern "C" MLIR_RUNNERUTILS_EXPORT void
xsmm_binary_invoke(const libxsmm_datatype dType,  const libxsmm_datatype cType, int64_t addr,
                   void *alignedPtrLhs, int64_t offsetLhs, void *alignedPtrRhs,
                   int64_t offsetRhs, void *alignedPtrOut, int64_t offsetOut);

extern "C" MLIR_RUNNERUTILS_EXPORT void
xsmm_brgemm_invoke(const libxsmm_datatype dType,  const libxsmm_datatype cType, int64_t addr,
...
extern "C" MLIR_RUNNERUTILS_EXPORT void xsmm_fused_brgemm_invoke(
    const libxsmm_datatype dType,  const libxsmm_datatype cType, int64_t addr, void *alignedPtrA,
